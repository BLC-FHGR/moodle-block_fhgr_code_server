...
/**
 * Block FHGR Code Server - Per-instance configuration form.
 *
...
class block_fhgr_code_server_edit_form extends block_edit_form {
    protected function specific_definition($mform) {
        ...
        $mform->addHelpButton('config_key', 'key', 'block_fhgr_code_server');
        ...
        $mform->addHelpButton('config_mode', 'mode', 'block_fhgr_code_server');
