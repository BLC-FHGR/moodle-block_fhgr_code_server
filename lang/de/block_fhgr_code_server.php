...
/**
 * Block FHGR Code Server - German language strings.
 *
...
$string['key_help'] = 'Dieser Schlüssel ist erforderlich, um eine Verbindung zum Code Server herzustellen. Du erhältst ihn vom Moodle Administrator.';
...
$string['availabilitynotice'] = 'Dieser Block muss auf der Seite "Seite des Testversuchs" oder auf "Jeder Testseite" verfügbar sein. Ausserdem Muss in den Testeinstellungen "Blöcke bei den Testversuchen anzeigen" aktiviert sein';
$string['mode'] = 'Modus';
